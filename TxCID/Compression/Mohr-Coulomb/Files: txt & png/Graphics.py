...
def Triaxial_1(q, e1, pE, eV, e, q_data, e1_data, pE_data, eV_data, e_data, size_titulo, size_ejes, size_leyenda):
    ...
    plt.subplot(221)
    l2 = plt.plot(e1, q, "r")
    l5 = plt.plot(e1_data,q_data, "brown")
...
def graphics_triaxial(q, Eps1, pE, Evol, e):
    ...
    l1, l4 = Triaxial_0(q_0, e1_0, pE_0, eV_0, e_0, q_data_0, e1_data_0, pE_data_0, eV_data_0, e_data_0, size_titulo, size_ejes, size_leyenda)
    l2, l5 = Triaxial_1(q_1, e1_1, pE_1, eV_1, e_1, q_data_1, e1_data_1, pE_data_1, eV_data_1, e_data_1, size_titulo, size_ejes, size_leyenda)
    l3, l6 = Triaxial_2(q_2, e1_2, pE_2, eV_2, e_2, q_data_2, e1_data_2, pE_data_2, eV_data_2, e_data_2, size_titulo, size_ejes, size_leyenda)
