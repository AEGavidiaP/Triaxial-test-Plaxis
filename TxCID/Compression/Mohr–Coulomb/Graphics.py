...
def Triaxial_0(q, e1, pE, eV, e, q_data, e1_data, pE_data, eV_data, e_data, size_titulo, size_ejes, size_leyenda, str_ax):
...
def graphics_triaxial(q, Eps1, pE, Evol, e, consolidation, str_ax):
    ...
    if i == 1:
        leyenda_2 = ["Plaxis-50kPa", "Test-50kPa", "Plaxis-100kPa", "Test-100kPa"]
        plt.legend([l1, l2, l3, l4], labels=leyenda_2, bbox_to_anchor=(1.05, 0), loc=3, borderaxespad=0, fontsize = size_leyenda)
    if i == 2:
        leyenda_3 = ["Plaxis-50kPa", "Test-50kPa", "Plaxis-100kPa", "Test-100kPa", "Plaxis-200kPa", "Test-200kPa"]
        plt.legend([l1, l2, l3, l4, l5, l6], labels=leyenda_3, bbox_to_anchor=(1.05, 0), loc=3, borderaxespad=0, fontsize = size_leyenda)
